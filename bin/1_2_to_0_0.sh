...
sed -i '0,/spidev1.2/s//spidev0.0/' /opt/ttn-gateway/lora_gateway/libloragw/src/loragw_spi.ftdi.c
sed -i '0,/spidev1.2/s//spidev0.0/' /opt/ttn-gateway/packet_forwarder/poly_pkt_fwd/src/poly_pkt_fwd.c

sed -i '0,/SX1301_RESET_BCM_PIN=22/s//SX1301_RESET_BCM_PIN=13/' /opt/ttn-gateway/bin/start.sh
